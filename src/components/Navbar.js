...
function Navbar() {
  ...
  async function updateButton() {
    ...
    ethButton.classList.remove("hover:bg-blue-70");
    ethButton.classList.remove("bg-blue-500");
    ethButton.classList.add("hover:bg-green-70");
    ethButton.classList.add("bg-green-500");
  }
